...
namespace System.Globalization
{
    ...
    public class FormLanguageSwitchSingleton
    {
        ...
        {
            if (resources.BaseName.ToString() != "ZedGraphControl" && resources.BaseName.ToString() != "QueryBuilder" && resources.BaseName.ToString() != "SqlTextEditor")
            {
        ...
        private void SetProperty(System.Windows.Forms.Control control, string propertyName, System.Resources.ResourceManager resources)
        {
            try
            {
                ...
                if (propertyInfo != null && resources.BaseName.ToString() != "ZedGraphControl" && resources.BaseName.ToString() != "QueryBuilder" && resources.BaseName.ToString() != "SqlTextEditor")
                {
        ...
        {
            if (treeView.Nodes.Count > 0 && resources.BaseName != "QueryBuilder")
            {
        ...
        {
            if (resources.BaseName != "QueryBuilder")
            {
